...
export function FleetMark({ className }: { className?: string }) {
  return (
    <svg viewBox="0 0 72 52" className={cn("h-10 w-14", className)} aria-hidden="true">
...
export function Logo({ compact = false }: { compact?: boolean }) {
  return (
    <Link to="/" className="flex min-w-0 items-center gap-2 text-fg no-underline" aria-label="Bossnu SlieLo home">
