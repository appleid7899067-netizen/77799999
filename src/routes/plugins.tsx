...
type Plugin = { name: string; description: string; kind: string; icon: typeof Github; action: "google" | "github" | "vercel" | "external"; url?: string };
